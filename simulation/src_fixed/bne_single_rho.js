...
function setElementsLayout() {
	...
	btAnim.innerHTML = "Animation OFF";
...
//	lines += "NEXP 10\n";
	...
	lines += "RHOG_INT 700 720 740 760 780 800 820 840 860 880\n";    	// Grains density 1 kg/m3
	lines += "RHOG_BED 700 720 740 760 780 800 820 840 860 880\n";    	// Grains density 2 kg/m3
	lines += "NUMG_BED 100\n";      // Number of grains -
...
//	rhog_int = getValue(lines, "RHOG_INT");
//	rhog_bed = getValue(lines, "RHOG_BED");
	numg_bed = getValue(lines, "NUMG_BED");	
	geng = getValue(lines, "GENG");
	fixpos = getValue(lines, "FIXPOS");
//	show_animation = getValue(lines, "SHOW_ANIM");
